<!-- card -->
<article class="products__content__row__container__row__card bg-white-500 shadow">
    <!-- thumbnail -->
    <div class="products__content__row__container__row__card__thumbnail">
    ...
    <!-- content -->
    <div class="products__content__row__container__row__card__content p-4">
        <!-- header -->
        <header class="products__content__row__container__row__card__content__header">
        ...
        <!-- body -->
        <div class="products__content__row__container__row__card__content__body">
