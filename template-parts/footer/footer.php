<footer class="footer clr-white-500">
    <!-- content -->
    <div class="footer__content bg-dark-gray-500 t-justify">
        <div class="container">
            <!-- row -->
            <div class="footer__content__row grid">
                <!-- brand -->
                <div class="footer__content__row__brand">
                    <img src="<?= image('logo-rodape.svg', 'svg'); ?>" alt="E-Location" title="E-Location" loading="lazy">

                    <!-- content -->
                    <div class="footer__content__row__brand__content mt-4">
                        <p class="mb-2">A E-Location é um braço do Grupo PL Engenharia e parte integrante da holding Capital 33</p>

                        <ul class="d-flex gp-1 ai-center">
                            <li class="mr-2">
                                <a class="link-white-500" rel="nofollow noreferrer noopener" href="<?= CONTACT['facebook']; ?>" title="Siga a E-Location no Facebook" target="_blank">
                                    <i class="icon-facebook"></i>
                                </a>
                            </li>
                            <li class="mr-2">
                                <a class="link-white-500" rel="nofollow noreferrer noopener" href="<?= CONTACT['instagram']; ?>" title="Siga a E-Location no Instagram" target="_blank">
                                    <i class="icon-instagram"></i>
                                </a>
                            </li>
                            <li>
                                <a class="link-white-500" rel="nofollow noreferrer noopener" href="<?= CONTACT['linkedin']; ?>" title="Siga a E-Location no Linkedin" target="_blank">
                ...
                <div class="footer__content__row__contact">
                    ...
                    <ul>
                        ...
                        <li>
                            <a class="link-white-500" rel="nofollow noreferrer noopener" href="<?= CONTACT['addressLink']; ?>" target="_blank" title="Venha conhecer a E-Location">
                ...
                <div class="footer__content__row__about">
                    ...
                    <p>Aqui você encontra equipamentos de qualidade, que atendem à todos os requisitos e normas de segurança do trabalho e meio ambiente, além de profissionais capacitados, que visam a qualidade do serviço e satisfação do cliente</p>
                </div>
                <!-- end of about -->
            </div>
            <!-- end of row -->
    ...
    <!-- copyright -->
    <div class="footer__content__copyright bg-dark-gray-500 clr-white-500 t-center py-1">
        <div class="container">
