<!-- card -->
<article class="highlight__row__card bg-white-500 shadow">
    <!-- thumbnail -->
    <div class="highlight__row__card__thumbnail">
    ...
    <!-- content -->
    <div class="highlight__row__card__content p-4">
        <!-- header -->
        <header class="highlight__row__card__content__header">
        ...
        <!-- body -->
        <div class="highlight__row__card__content__body">
